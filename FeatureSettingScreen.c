...
VOID FeatureList_callback(GX_VERTICAL_LIST *list, GX_WIDGET *widget, INT index)
{
    ...
    if (!result)	// NOPE? Let create the item.
    {
		...
		childsize.gx_rectangle_left = feature->m_ItemWidget.gx_widget_size.gx_rectangle_right - 58 - 14;
        ...
        gx_utility_rectangle_define(&childsize, 0, 0, feature->m_ItemWidget.gx_widget_size.gx_rectangle_right - 58 - 24, 52);
