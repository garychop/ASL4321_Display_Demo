...
//	g_PadSettings[RIGHT_PAD].m_DiagnosticProportional_ID = RIGHT_PAD_PROP_BTN_ID;
	...
	//g_PadSettings[FORWARD_PAD].m_DirectionIcons[OFF_DIRECTION] = &SetPadDirectionScreen.SetPadDirectionScreen_CenterPad_Off_Button;
	//g_PadSettings[FORWARD_PAD].m_DirectionIcons[RIGHT_DIRECTION] = &SetPadDirectionScreen.SetPadDirectionScreen_CenterPad_RightArrow_Button;
	//g_PadSettings[FORWARD_PAD].m_DirectionIcons[LEFT_DIRECTION] = &SetPadDirectionScreen.SetPadDirectionScreen_CenterPad_LeftArrow_Button;
	//g_PadSettings[FORWARD_PAD].m_DirectionIcons[FORWARD_DIRECTION] = &SetPadDirectionScreen.SetPadDirectionScreen_CenterPad_ForwardArrow_Button;
...
//	g_PadSettings[FORWARD_PAD].m_DiagnosticOff_ID = FORWARD_PAD_OFF_BTN_ID;
//	g_PadSettings[FORWARD_PAD].m_DiagnosticDigital_ID = FORWARD_PAD_DIGITAL_BTN_ID;
//	g_PadSettings[FORWARD_PAD].m_DiagnosticProportional_ID = FORWARD_PAD_PROP_BTN_ID;
...
//	g_PadSettings[REVERSE_PAD].m_DiagnosticOff_ID = RIGHT_PAD_OFF_BTN_ID;
//	g_PadSettings[REVERSE_PAD].m_DiagnosticDigital_ID = RIGHT_PAD_DIGITAL_BTN_ID;
//	g_PadSettings[REVERSE_PAD].m_DiagnosticProportional_ID = RIGHT_PAD_PROP_BTN_ID;
